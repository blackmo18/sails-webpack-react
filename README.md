# NOTE: this is modified sails-webpack-seed project to work with the current version fo react, sails and other modules in package.json

# sails-webpack-seed https://github.com/sailshq/sails-webpack-seed

a [Sails](http://sailsjs.com) 1.1.0 application utilizing the Webpack 4.x asset bundler.
